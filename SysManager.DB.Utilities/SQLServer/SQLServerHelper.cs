...
namespace SysManager.DB.Utilities
{
    ...
    public abstract class SQLServerHelper
    {
        ...
        /// SQLServer数据库连接字符串
        /// </summary>
        public static string connectionString = DESEncryptHelper.Decrypt(ConfigurationManager.ConnectionStrings["SQLConnString"].ConnectionString);
        ...
        {
            int result;
            SqlCommand command = SQLServerHelper.BuildQueryCommand(connection, storedProcName, parameters);
